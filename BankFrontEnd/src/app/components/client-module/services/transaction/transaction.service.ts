...
export class TransactionService {
  ...
  submitInnerBankTransferRequest(transaction: transferRequestDto): Observable<string> {
    return this.http.post("transaction/inner-bank", transaction, { responseType: 'text' });
  }
}
